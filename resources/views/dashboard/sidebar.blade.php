<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-file-image-o"></i> <span>Feane Admin</span></a>
        </div>
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="{{asset('storage/'.$currentUser->image)}}" alt="..." class="img-circle profile_img">
            </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    <li><a><i class="fa fa-desktop"></i> Admins <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{route('addAdmin')}}">Add Admin</a></li>
                            <li><a href="{{route('admins')}}">Admins List</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a><i class="fa fa-desktop"></i> Tables <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{route('tables')}}">Tables List</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
