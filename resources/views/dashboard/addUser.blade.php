        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{route('storeUser')}}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                            @csrf
                            @method('post')
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="user-name" name="userName" class="form-control @error('userName') is-invalid @enderror">
                                    @error('userName')
                                    <div style="color: red;  margin-top: 3px;">
                                        {{$message}}
                                    </div>
