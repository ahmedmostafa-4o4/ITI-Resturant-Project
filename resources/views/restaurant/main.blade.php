...
<body class="sub_page">
    ...
    <div class="hero_area">
        <div class="bg-box">
            <img src="restaurant/images/hero-bg.jpg" alt="">
        </div>
    ...
    <!-- jQery -->
    <script src="{{ asset('restaurant/js/jquery-3.4.1.min.js') }}"></script>
    </script>
    </script>
    </script>
    <!-- popper js -->
    ...
    <!-- bootstrap js -->
    <script src="{{ asset('restaurant/js/bootstrap.js') }}"></script>
    </script>
    </script>
    </script>
    <!-- owl slider -->
    ...
    <!-- Google Map -->
    <script src="{{ asset('https://maps.googleapis.com/maps/api/js?key=AIzaSyCh39n5U-4IoWpsVGUHWdqB6puEkhRLdmI&callback=myMap') }}"></script>
    </script>
    </script>
    </script>
    <!-- End Google Map -->
